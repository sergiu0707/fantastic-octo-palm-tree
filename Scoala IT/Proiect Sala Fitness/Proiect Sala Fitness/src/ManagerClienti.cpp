...
void ManagerClienti::setInstructorIndex()   // set client index from instructor + update Instructor hours
{
    int index = 0;
    int index3;
    short ore;
...
void ManagerClienti::displayInstructor()    // display instructor list
{
 ...
 void ManagerClienti::deleteClient()        // delete client
 {
    short index = 0;
  ...
  void ManagerClienti::info()  // display instructor + client
  {
      int index;
      int index2;
  ...
  void ManagerClienti::validate() // validation method
{
    cin.clear();
    cin.ignore(200, '\n');
}
